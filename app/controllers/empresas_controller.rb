...
class EmpresasController < ApplicationController
  ...
  def destroy
    @empresa.destroy
    respond_to do |format|
      format.html { redirect_to empresas_url, notice: 'Empresa excluída com sucesso.' }
  ...
  def empresa_params
    params.require(:empresa).permit(:nome, :ativo, :observacao)
  end
end
